            ...
            <div class="contact-header">
                <div class="row align-items-center">
                    <div data-aos="fade-up" class="col-lg-6 aos-init aos-animate">
                        <h1 style="font-size:60px" class="page-header-title">Rest wachtwoord</h1>
                        <h2 style="margin-bottom: 150px">Maak een nieuw gebruikersnaam en wachtwoord om in het systeem in te loggen.</h2>

                        <div class="mb-lg-3 row">
                            <h4 style="font-size:18px;">Gaat er toch iets miss neem gerust contact met ons op.</h4>
                        </div>
                    ...
                    <div data-aos="fade-up" data-aos-delay="50" class="col-lg-6 aos-init aos-animate">
                        ...
                        <div class="container input-field">
                            <form method="POST" action="{{ route('password.update') }}">
                                ...
                                <input class="input-field-input mb-4" type="hidden" name="token" value="{{ $request->route('token') }}">

                                <h3 class="mt-4">Your email</h3>
                                <input class="input-field-input mb-4" type="email" name="email" value="{{ old('email', $request->email) }}" placeholder="Enter your email here..." required autofocus />

                                <h3 class="mt-4">Your password</h3>
                                <input class="input-field-input mb-4" type="password" name="password" placeholder="Enter your password here..." required autocomplete="new-password" />

                                <h3 class="mt-4">Confirm password</h3>
                                <input class="input-field-input mb-4" type="password" name="password_confirmation" placeholder="Enter your password here..." required autocomplete="new-password" />

                                <label style="font-size: 20px;" class="mt-4">{{ __('Remember me') }}</label>
                                <input class="input-field-input-checkbox ml-3" type="checkbox" name="remember">
