                    ...
                    <div data-aos="fade-up" data-aos-delay="50" class="col-lg-6 aos-init aos-animate">
                        ...
                        <div class="container input-field">
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <input class="input-field-input mb-4" type="password" name="password" placeholder="Enter your password here..." required autocomplete="current-password">
                                ...
                                @if (Route::has('password.request'))
                                    <a href="{{ route('password.request') }}">
                                        <h4 class="mt-4 mb-4">{{ __('Forgot your password?') }}</h4>
                                    </a>
                                @endif
