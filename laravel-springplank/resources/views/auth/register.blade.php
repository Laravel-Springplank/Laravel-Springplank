                    ...
                    <div data-aos="fade-up" data-aos-delay="50" class="col-lg-6 aos-init aos-animate">
                        ...
                        <div class="container input-field">
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <input class="input-field-input mb-4" type="text" name="name" value="{{ old('name') }}" placeholder="Enter your name here..." required autofocus autocomplete="name" />

                                <h3 class="mt-4">Your email</h3>
                                <input class="input-field-input mb-4" type="email" name="email" value="{{ old('email') }}" placeholder="Enter your email here..." required />
                                ...
                                <a href="{{ route('login') }}">
                                    <h4 class="mt-4 mb-4">{{ __('Already registered?') }}</h4>
                                </a>
