            ...
            <div class="contact-header">
                <div class="row align-items-center">
                    <div data-aos="fade-up" class="col-lg-6 aos-init aos-animate">
                        <h1 style="font-size:60px" class="page-header-title">Verify email</h1>
                        <h2 style="margin-bottom: 150px">Dubbel check je email om in te
                            <br> kunnen inloggen.</h2>
                    ...
                    <div data-aos="fade-up" data-aos-delay="50" class="col-lg-6 aos-init aos-animate">
                        <div class="container input-field">
                            <h3 class="mt-4">{{ __('Thanks for signing up! Before getting started, could you verify your email address by clicking on the link we just emailed to you? If you didn\'t receive the email, we will gladly send you another.') }}</h3>
                            ...
                            <form method="POST" action="{{ route('verification.send') }}">
                                ...
                                <button class="btn btn-lg sendBtn mb-4 mt-4" type="submit">
