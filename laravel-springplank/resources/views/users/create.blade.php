                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="input-field-input mb-4" type="text" name="name" class="form-control" placeholder="Voer gebruikers naam in...">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <h3>Email:</h3>
                                    <input class="input-field-input mb-4" type="text" name="email" class="form-control" placeholder="Voer email in...">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <h3>Wachtwoord:</h3>
                                    <input class="input-field-input mb-4" type="password" name="password" class="form-control" placeholder="Voer wachtwoord in...">
                                </div>
                            </div>
                        </div>
