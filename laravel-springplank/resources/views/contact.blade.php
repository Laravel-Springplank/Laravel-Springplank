                    ...
                    <div class="info-card mb-lg-3 row">
                        <svg class="" xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36">
                            <path id="Icon_awesome-phone-alt" data-name="Icon awesome-phone-alt"
                                ...
                                transform="translate(0 0)" fill="#5468ff"></path>
                        </svg>
                        <h2 style="font-size: 26px; margin: auto;" class="ml-lg-5">+31 6 12345678</h2>
                    </div>
                    <div class="info-card mb-lg-3 row">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40.494" height="32.395"
                            viewBox="0 0 40.494 32.395">
                            <path id="Icon_material-email" data-name="Icon material-email"
                                d="M39.445,6H7.049A4.044,4.044,0,0,0,3.02,10.049L3,34.346A4.061,4.061,0,0,0,7.049,38.4h32.4a4.061,4.061,0,0,0,4.049-4.049v-24.3A4.061,4.061,0,0,0,39.445,6Zm0,8.1-16.2,10.123L7.049,14.1V10.049l16.2,10.123,16.2-10.123Z"
                                transform="translate(-3 -6)" fill="#5468ff"></path>
                        </svg>
                    ...
                    <div class="info-card mb-lg-3 row">
                        <svg xmlns="http://www.w3.org/2000/svg" width="26.18" height="37.4" viewBox="0 0 26.18 37.4">
                            <path id="Icon_material-location-on" data-name="Icon material-location-on"
                                d="M20.59,3A13.08,13.08,0,0,0,7.5,16.09c0,9.818,13.09,24.31,13.09,24.31S33.68,25.908,33.68,16.09A13.08,13.08,0,0,0,20.59,3Zm0,17.765a4.675,4.675,0,1,1,4.675-4.675A4.677,4.677,0,0,1,20.59,20.765Z"
                                transform="translate(-7.5 -3)" fill="#5468ff"></path>
                        </svg>
                    ...
                    <div class="container input-field">
                        <form action="{{ route('contact.send') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="input-field-input @error('name') is-invalid @enderror" type="text" name="name"
                                    value="{{ old('name') }}" placeholder="Enter your name here...">
                                @error('name')
                            ...
                            <div class="form-group">
                                <h3>Mail</h3>
                                <input class="input-field-input @error('email') is-invalid @enderror" type="email" name="email" value="{{ old('email') }}"
                            ...
                            <div class="form-group">
                                <h3>Message</h3>
                                <textarea class="input-field-input-message @error('message') is-invalid @enderror" name="message" rows="12" cols="57"
                            ...
                            <button type="submit" class="btn btn-lg sendBtn mb-4">Send message</button>
                        </form>
                    </div>
                </div>
            </div>
